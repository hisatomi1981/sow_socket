...
<head>
	...
	<script src="js/function_senddata_ud.js"></script>
...
<body style="padding-top: 60px">
	...
	<xml xmlns="https://developers.google.com/blockly/xml" id="toolbox" style="display: none">
		...
		<category name="信号待ち" colour="#8a97b8">
			...
			<block type="wait_light"></block>
			<block type="wait_dark"></block>
			<?php if (show_feature(64) || show_feature(65)) { ?>
	...
	<nav class="navbar fixed-top navbar-expand-lg navbar-light bg-light">
		...
		　明るさ：<span id="cdSData"></span>
		　外部センサ：<span id="gaibuData"></span>
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent1">
			...
			<li class="nav-item dropdown">
				...
				<li><a class="dropdown-item" onclick="downloadCode()" href="#">ファイルへ保存</a></li>
			...
			<!-- 接続処理 -->
			<li class="nav-item">
				<a class="nav-link" href="#" onclick="connectHID()">接続処理</a>
			</li>
			...
			<li class="nav-item dropdown">
				...
				<?php if (show_feature(64)) { ?>
					<li><a class="dropdown-item" onclick="gestureDisplay()" href="#">機械学習（画像分析）</a></li>
				...
				<?php if (show_feature(65)) { ?>
					<li><hr class="dropdown-divider"></li>
					<li><a class="dropdown-item" onclick="teachablemachineDisplay()" href="#">画像（TeachableMachine）</a></li>
					<li><a class="dropdown-item" onclick="teachablemachineDisplay_pose()" href="#">ポーズ（TeachableMachine）</a></li>
					<li><a class="dropdown-item" onclick="teachablemachineDisplay_preset()" href="#">プリセット（TeachableMachine）</a></li>
				<?php }	?>
				...
				<li><a class="dropdown-item" href="help/client.pdf" target="_blank">ヘルプ</a></li>
				<li><a class="dropdown-item" href="help/procedure_b_c.pdf" target="_blank">操作手順</a></li>
				</ul>
			</li>
			...
			<li class="nav-item dropdown">
				...
				<li><a class="dropdown-item" href="https://youtu.be/y_1tNZrrVtM" target="_blank">2人で通信</a></li>

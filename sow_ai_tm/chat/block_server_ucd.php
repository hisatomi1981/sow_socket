...
<head>
	...
	<script src="https://cdnjs.cloudflare.com/ajax/libs/crypto-js/3.1.2/rollups/aes.js"></script><!--暗号化復号化-->
	<script src="https://cdnjs.cloudflare.com/ajax/libs/crypto-js/3.1.2/rollups/pbkdf2.js"></script><!--パスワードハッシュの生成-->
	<!-- Blocklyのライブラリ -->
...
<body style="padding-top: 70px">
	...
	<xml xmlns="https://developers.google.com/blockly/xml" id="toolbox" style="display: none">
		<category name="制御" colour="#ffbf00">
			...
			<block type="server_if_block_ai_kinsi"></block>
		...
		<category name="設定" colour="#ff8c1a">
	...
	<nav class="navbar fixed-top navbar-expand-lg navbar-light bg-light">
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent1">
			...
			<li class="nav-item dropdown">
				...
				<li><a class="dropdown-item" onclick="savelog()" href="#">ログの保存</a></li>

							...
							<div style="height: 150px; background-color: #FFDDC6">
								...
								<div id="para_sensor" style="display:none;">
									<select name="select" id="parasensor" class="select" onchange="change_pulldown(parasensor)">
										...
										<?php if (show_feature(94) || show_feature(95)) { ?>
						...
						<table width="100%" border="0">
							<tbody>
								<tr>
									...
									<td rowspan="2">
										<a class="sendbtn text-decoration-none" href="#" onclick="sendMessage('3','<?php addslashes(htmlspecialchars($school_id_userid, ENT_QUOTES, 'UTF-8')) ?>')" id="play_set">　実行　</a>
									</td>
								</tr>
								<tr>
									<td>
	...
	<nav class="navbar fixed-top navbar-expand-lg navbar-light bg-light">
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent1">
			...
			<li class="nav-item dropdown">
				...
				<li>
					<!-- label のままでもOK。クリックで input[file] を開けます -->

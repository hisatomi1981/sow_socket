...
<head>
	...
	<script src="jsfglow/function_senddata_ud.js"></script>
...
<body onload="init()" style="padding-top: 70px">
	<div class="container-fluid" id="droppable">
		...
		<div class="row justify-content-right">
			<div class="col-auto upload_back" id="programarea">
				...
				ファイル１：<input type="file" name="img" accept=".ud1,.ud1f,.ud1w,.udsd" id="pro_file1"><br>
				ファイル２：<input type="file" name="img" accept=".ud1,.ud1f,.ud1w,.udsd" id="pro_file2"><br>
				ファイル３：<input type="file" name="img" accept=".ud1,.ud1f,.ud1w,.udsd" id="pro_file3"><br>
			</div>
		</div>
		<div class="row justify-content-right">
			<!--  style="display:none;" -->
	...
	<nav class="navbar fixed-top navbar-expand-lg navbar-light bg-light">
		<span id="schooid">双方向ネットワークアプリ(UD ipad)</span>　：　
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent1">
			...
			<li class="nav-item dropdown">
				...
				<li><a class="dropdown-item aback" href="#" onclick="saveCode(); return false;">ブラウザへ保存</a></li>
				<li><a class="dropdown-item aback" href="#" onclick="restoreBlocks(); return false;">ブラウザから読み込み</a></li>
				<li><hr class="dropdown-divider"></li>

				<li><a class="dropdown-item aback" href="#" id="filesave" onclick="downloadCode_ipad(); return false;">ファイルへ保存</a></li>
			...
			<!-- 接続処理 -->
			<li class="nav-item">
				<a class="nav-link aback" ontouchstart="" href="#" onclick="connect_iPad(); return false;">接続処理　</a>
			</li>
			...
			<li class="nav-item dropdown">
				...
				<li><a class="dropdown-item aback" href="#" onclick="groupDisplay(); return false;">グループ設定</a></li>
				<li><hr class="dropdown-divider"></li>
				<li><a class="dropdown-item aback" href="help/group.pdf" target="_blank" rel="noopener">グループ送信手順</a></li>
				</ul>
			</li>

			<!-- 操作 -->
			<li class="nav-item dropdown">
				<a class="nav-link dropdown-toggle" href="#" id="navbarDropdownOperate" role="button"
				data-bs-toggle="dropdown" aria-expanded="false">
				操作
				</a>
				<ul class="dropdown-menu" aria-labelledby="navbarDropdownOperate">
				<li><a class="dropdown-item aback" ontouchstart="" href="#" onclick="allselectcommanad(); return false;">全選択</a></li>
				<li><hr class="dropdown-divider"></li>
				<li><a class="dropdown-item aback" ontouchstart="" href="#" onclick="deletecommanad(); return false;">削除</a></li>
				<li><hr class="dropdown-divider"></li>
				<li><a class="dropdown-item aback" ontouchstart="" href="#" onclick="undocommanad(); return false;">元に戻す</a></li>
				<li><hr class="dropdown-divider"></li>
				<li><a class="dropdown-item aback" ontouchstart="" href="#" onclick="redocommanad(); return false;">やり直す</a></li>
				</ul>
			</li>
			...
			<li class="nav-item dropdown">
				...
				<li><a class="dropdown-item aback" href="#" onclick="allDelete(); return false;">プログラム削除</a></li>
				<li><hr class="dropdown-divider"></li>

				<li><a class="dropdown-item aback" href="#" onclick="printDisplay(); return false;">レポート作成</a></li>
				<!--
				...
				<?php }	?>
				<li><hr class="dropdown-divider"></li>
				<li><a class="dropdown-item aback" href="#" onclick="change_network_no_Display(); return false;">設定</a></li>
				<li><hr class="dropdown-divider"></li>
				<li><a class="dropdown-item aback" href="#" onclick="display_net_no(); return false;">利用中のネットワーク番号</a></li>
				<li><hr class="dropdown-divider"></li>
				<li><a class="dropdown-item aback" href="#" onclick="cash_clear_all(); return false;">すべてのキャッシュをクリア</a></li>
				<li><hr class="dropdown-divider"></li>
				<li><a class="dropdown-item aback" href="help/client_flow.pdf" target="_blank" rel="noopener">ヘルプ</a></li>
				<li><a class="dropdown-item aback" href="help/procedure_f_c.pdf" target="_blank" rel="noopener">操作手順</a></li>
				</ul>
			</li>
			...
			<li class="nav-item dropdown">
				...
				<li><a class="dropdown-item aback" href="https://youtu.be/o8IumegiS-o" target="_blank" rel="noopener">ネットワーク番号について</a></li>
				<li><a class="dropdown-item aback" href="https://youtu.be/LgdRVmeN8fc" target="_blank" rel="noopener">2人で通信</a></li>
				<li><a class="dropdown-item aback" href="https://youtu.be/MrmThZ3aELo" target="_blank" rel="noopener">3人で通信</a></li>
				<li><a class="dropdown-item aback" href="https://youtu.be/mXYWFWx0wIU" target="_blank" rel="noopener">3人で通信（禁止ワード編）</a></li>
				<li><a class="dropdown-item aback" href="https://youtu.be/S5WC9F7rxnI" target="_blank" rel="noopener">3人で通信（パスワード編）</a></li>
				</ul>
			</li>
			...
			<!-- 右端の削除ボタン -->
			<a class="deletebtn aback" ontouchstart="" href="#" onclick="deletecommanad(); return false;">　削除　</a>
		</div>
	</nav>

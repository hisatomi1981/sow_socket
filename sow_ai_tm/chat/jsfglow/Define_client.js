  function init() {
	...
	function showLinkLabel(e) {
	  ...
	  if (label !== null) {
		if (e.subject.fromNode.data.category === "Conditional" || e.subject.fromNode.data.category === "Recieve_Conditional") {
		  label.visible = true;
